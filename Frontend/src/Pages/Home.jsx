          ...
          <Col lg="6">
            <div className="hero__content">
              ...
              <h1>
                ...
                <span className="highlight">Unforgettable Memories</span>
              </h1>
              <p>
              Discover the world with us. Whether it's serene beaches, bustling cities, or scenic mountains,
                  we help you create stories worth sharing. Your adventure starts here—let us make it extraordinary. 
              </p>
            </div>
          </Col>
          <Col lg="2">
        ...
        <Row>
          <Col lg="6">
            <div className="experience__content">
              ...
              <p>
                For over a decade, we’ve helped thousands of travelers explore the world in comfort and style.
                From solo journeys to family vacations, we bring expertise and passion to every trip we plan. 
              </p>
            </div>
